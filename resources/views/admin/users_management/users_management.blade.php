                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> {{ $title }}
                                <a href="{{ route('users_add_new', ['userType' => 'user']) }}" class="btn theme-btn">Thêm mới</a>
                            </h1>
    ...
    <script>
        $(document).ready(function() {
            $('#jDataTable').DataTable({
                processing: true,
                serverSide: false,
                ajax: '{{ route('get_users_data', ['userType' => 'users']) }}',
                language: {
        ...
        function updateUserStatus(obj)
        {
            ...
            $.ajax({
                url: '{{ route('update_user_status', ['userType' => 111]) }}',
                type: "POST",
