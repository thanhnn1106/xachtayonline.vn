                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-1 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="i-checks">
                                    <input id="status_1" type="radio" value="1" @if (old('is_active') == 1) checked="checked" @endif name="is_active" class="form-control-custom radio-custom">
                                    <label for="status_1">@lang('app.active')</label>
                                </div>
                                <div class="i-checks">
                                    <input id="status_0" type="radio" value="0" @if (old('is_active') != 1) checked="checked" @endif name="is_active" class="form-control-custom radio-custom">
