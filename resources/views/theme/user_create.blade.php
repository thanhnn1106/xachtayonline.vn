    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 col-xs-12">
                ...
                <div class="login">
                    <h3 class="authTitle">Đăng ký hoặc <a href="{{ route('login') }}">@lang('app.login')</a></h3>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group {{ $errors->has('first_name')? 'has-error':'' }} ">
                                <input type="text" name="first_name" id="first_name" class="form-control" value="{{ old('first_name') }}" placeholder="Tên" tabindex="1">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group {{ $errors->has('last_name')? 'has-error':'' }} ">
                                <input type="text" name="last_name" id="last_name" class="form-control"  value="{{ old('last_name') }}" placeholder="Họ" tabindex="2">
                    ...
                    <div class="form-group {{ $errors->has('email')? 'has-error':'' }} ">
                        <input type="email" name="email" id="email" class="form-control" value="{{ old('email') }}" placeholder="Địa chỉ email" tabindex="3">
                        {!! $errors->has('email')? '<p class="help-block">'.$errors->first('email').'</p>':'' !!}

                    </div>

                    <div class="form-group {{ $errors->has('phone')? 'has-error':'' }}">
                        <input type="text" name="phone" id="phone" class="form-control" value="{{ old('phone') }}" placeholder="Số điện thoại" tabindex="4">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group {{ $errors->has('password')? 'has-error':'' }}">
                                <input type="password" name="password" id="password" class="form-control" placeholder="Mật khẩu" tabindex="5">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group {{ $errors->has('password_confirmation')? 'has-error':'' }}">
                                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="Nhập lại mật khẩu" tabindex="6">
					...
					<span class="button-checkbox">
						<label><input type="checkbox" name="agree" value="1" /> Tôi đồng ý </label>
					</span>
                        </div>
                        <div class="col-xs-8 col-sm-9 col-md-9">
                            Nhấp vào <strong class="label label-primary">Đăng ký</strong>, Bạn đồng ý với <a href="{{ route('single_page', 'terms-and-condition') }}" target="_blank">Điều kiện và điều khoản</a> đặt ra bởi trang web này, bao gồm quyền sử dụng cookies.
                        </div>
